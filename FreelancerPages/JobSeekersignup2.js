...
const JobSeekersignup2 = ({ navigation, route }) => {
  ...
  const initialState = update
    ? {
        expirationDate:
          freelancer.expirationDate !== undefined
            ? freelancer.expirationDate
            : "",
        emiratesId:
          freelancer.emiratesId !== undefined ? freelancer.emiratesId : "",
        emiratesIdFrontSide:
          freelancer.emiratesIdFrontSide !== undefined
            ? freelancer.emiratesIdFrontSide
            : "",
        emiratesIdBackSide:
          freelancer.emiratesIdBackSide !== undefined
            ? freelancer.emiratesIdBackSide
            : "",
        birthDate:
          freelancer.birthDate !== undefined ? freelancer.birthDate : "",
      }
    : {
        expirationDate: "",
        emiratesId: "",
  ...
  const [uploadedImage, setUploadeImage] = useState(
    update && freelancer.emiratesIdFrontSide !== undefined
      ? freelancer.emiratesIdFrontSide
      : ""
  );
  const [uploadedImage2, setUploadeImage2] = useState(
    update && freelancer.emiratesIdBackSide !== undefined
      ? freelancer.emiratesIdBackSide
      : ""
  );
  ...
  const [image, setImage] = useState(
    update &&
      freelancer.emiratesIdFrontSide !== undefined &&
      freelancer.emiratesIdFrontSide !== null
      ? `http://195.110.58.234:4000${freelancer.emiratesIdFrontSide}`
      : {}
  );
  const [image2, setImage2] = useState(
    update &&
      freelancer.emiratesIdBackSide !== undefined &&
      freelancer.emiratesIdBackSide !== null
      ? `http://195.110.58.234:4000${freelancer.emiratesIdBackSide}`
      : {}
  );
  console.log("freelancer.emiratesIdFrontSide", freelancer.emiratesIdFrontSide);
  const [uploaded, setUploaded] = useState(
    freelancer.emiratesIdFrontSide !== undefined ? true : false
  );
  const [uploaded2, setUploaded2] = useState(
    freelancer.emiratesIdBackSide !== undefined ? true : false
  );
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.subContainer}>
        ...
        {image.length && !uploaded ? (
          ...
          <UploadCard
            title="Front side of your Emirates ID"
        ...
        {image2.length && !uploaded2 ? (
          ...
          <UploadCard
            title="Back side of your Emirates ID"
