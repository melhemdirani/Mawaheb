  ...
  useEffect(() => {
    if(role === 'client'){
      ...
      .then((response) => {
        ...
        .unwrap()
        .then((response) => {setJob(response.job); console.log("response job", response.job)})
      })
      .catch((error) => {
    ...
    if(role === 'client'){
      ...
      .catch((error) => {
        ...
        if(error.message ===  "time conflict"){
          alert("You already have a job at this duration.")
            ...
            >
              <View style={styles.footer}>
                ...
                <View style={styles.footerInfo}>
                  ...
                  <Text style={styles.text}> {job.shift === 'night' ? "Night Shift" : "Day Shift"}</Text>
                </View>
                <View style={styles.footerInfo}>
