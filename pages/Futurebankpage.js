...
//   const {user, registerError, registerIsLoading} = useSelector((store) => store.user)}
...
//   useEffect(() => {
//     if(registerError === "Email already in use"){
//       alert("Email already in use, please register from a different email address")
//       navigation.navigate("JobSignUp")
//     }
//   }, [registerError])
//   const createJobSeeker2 = () => {
//     if(!registerIsLoading && !registerError && user !=={} && user!== undefined){
//       dispatch(
